...
int main(){
	...
	string a,b;
	cin >> a >> b;
	if(a[0] != '-' && b[0] != '-') substract("-"+b,a);
	else if(a[0] == '-' && b[0] == '-') substract(a,b.substr(1));
	else if(a[0] == '-' && b[0] != '-') cout << "-",add(a.substr(1),b);
	else if(a[0] != '-' && b[0] == '-') add(a,b.substr(1));
	return 0;
}
